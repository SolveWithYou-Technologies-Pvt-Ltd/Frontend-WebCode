...
const ApplyJob = () => {
  ...
  useEffect(() => {
    if (!isGeneral) {
      const fetchJob = async () => {
        try {
          const response = await axios.get(`https://backend-code-k530rfj5r-solve-with-you.vercel.app/api/jobs/public`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://backend-code-k530rfj5r-solve-with-you.vercel.app/api/applications", payload);
