...
import { fetchAdminQuoteById, updateAdminQuote } from "../../api/quoteApi";
...
const QuoteEdit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await updateAdminQuote(id, formData);
  ...
  if (loading) {
    return (
      <div className="flex w-full items-center justify-center p-10 min-h-[60vh]">
        <p className="text-[13px] font-medium text-slate-500">Loading editor...</p>
      </div>
    );
  }
