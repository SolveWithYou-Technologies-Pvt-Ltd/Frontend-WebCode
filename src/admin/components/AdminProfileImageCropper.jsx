...
const AdminProfileImageCropper = ({
  ...
  const handleFileChange = (
    ...
    if (
      ...
      setError(
        "Selected image must be smaller than 8 MB"
      );
      return;
    }
  ...
  const handleCropUpload =
    async () => {
      try {
        ...
        setError(
          uploadError.message ||
          "Unable to crop profile picture"
        );
      }
    };
